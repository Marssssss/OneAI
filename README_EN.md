...
<p align="center">
  <img src="assets/OneAI-main.png" alt="macOS app — default conversation home" width="760">
</p>

<p align="center"><em>macOS app · default home — brand entry + suggested topics, tap a topic to start.</em></p>

<p align="center">
  <img src="assets/oneai-tui-screenshot.jpg" alt="OneAI CLI — Plan mode" width="860">
</p>

<p align="center"><em>Interactive CLI (<code>oneai-cli</code>) · Plan mode — thinking bubble, plan panel, tool calls, approval.</em></p>

---

## Highlights

- **Many official frontends** — macOS / Windows apps, a VS Code extension, a browser extension, a CLI/TUI, and mobile apps; one engine feeds them all, each with its own native UI.
...
One engine — pick a frontend for your scenario.
...
Native SwiftUI, no Xcode required — the Command Line Tools are enough.
